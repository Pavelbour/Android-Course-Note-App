...
public class NoteViewHolder extends RecyclerView.ViewHolder {
    private final TextView titleTextView = itemView.findViewById(R.id.activity_note__note_title_edit_text);
    private final TextView contentTextView = itemView.findViewById(R.id.activity_note__note_content_edit_text);
    private final TextView dateTextView = itemView.findViewById(R.id.activity_note__note_date_edit_text);
